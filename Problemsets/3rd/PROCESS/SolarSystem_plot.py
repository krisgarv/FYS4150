...
"""
------------------------------------------------
USE WHEN ORIGO IS IN THE CENTER OF THE SUN
------------------------------------------------

Plotting the 2-body or 3-body system in 2D or 3D.
For 2-body in 2D:
Using the initial velocity for the Earth found as v = 2pi.

For 2-body in 3D:
Using the initial velocity for the Earth found from NASA HORIZON
(to be able to have a initial w (z-direction)).

For 3-body in 2D:
Using the initial velocity for the Earth and Jupiter found from
NASA HORIZON.
...
def input_matrix_2D(numbodies):
    ...
    if numbodies == 2:
        ...
        #Init.positions:
        position_sun = (0.0, 0.0, 0.0)
        position_earth = (1.003538121253694, -5.782251806221399E-03, -2.257327676060083E-06)
        position_jupiter = (-2.795086855829125, -4.593269013324874, 8.161900152196526E-02)
        #Init.velocities:
        velocity_sun = (0.0, 0.0, 0.0)
