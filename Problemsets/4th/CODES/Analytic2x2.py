...
# Initial lattice configuration, set to ground state
spin_matrix = np.ones((num_spins, num_spins), np.int8)

#====Calculating the numerical solution for a range of Monte Carlo cycles.======
...
#===================Print analytic solution to terminal========================
